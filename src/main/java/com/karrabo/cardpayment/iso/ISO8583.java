...
public class ISO8583 {
    ...
    public byte[] isotostr() {
        ...
        if (dataOffset != 0) {
            ...
            if (sec == true) {
                ...
                log.info(TAG, "TMP3: " + new String(TMP3));
                ISO8583 unpackISO8583 = new ISO8583();
                unpackISO8583.strtoiso(TMP3);
                ProfileParser.sending = new String[128];
                Utilities.logISOMsg(unpackISO8583, ProfileParser.sending);
    ...
    public int strtoiso(byte[] src) {
        ...
        log.info("CHECKING 1: " + ISOUtil.hexString(src));
        byte[] data1 = BCDASCII.hexStringToBytes(ISOUtil.hexString(src));
        log.info("CHECKING 2: " + ISOUtil.hexString(data1));
        byte[] packData = BCDASCII.hexStringToBytes(new String(data1));
        log.info("CHECKING 3: " + ISOUtil.hexString(packData));
    ...
    private void initCupISO8583Domain() {
        ...
        mISO8583Domain[69].setDomainProperty(3, R_ASC, FIX_LEN, "NETWORK MANAGEMENT INFORMATION CODE");//40
        ...
        mISO8583Domain[97].setDomainProperty(25, R_ASC, FIX_LEN, "Payee");
        mISO8583Domain[99].setDomainProperty(11, R_ASC, LLVAR_LEN, "RECEIVING INSTITUTION ID CODE"); //33
